...
/**
 * Authenticated routes for the daily summary and alerts. The typed/spoken
 * command bar this used to also serve (POST /api/assistant/turn) is gone —
 * Ask arcarna's draft_order tool calls runAssistantTurn() directly now
 * (server/ask/tools.ts), not over HTTP.
 */
