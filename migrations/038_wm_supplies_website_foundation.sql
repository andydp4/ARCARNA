...
CREATE TABLE IF NOT EXISTS website_theme_settings (
  ...
  primary_color varchar(16) NOT NULL DEFAULT '#FACC15',
  secondary_color varchar(16) NOT NULL DEFAULT '#111827',
  accent_color varchar(16) NOT NULL DEFAULT '#EF4444',
  background_color varchar(16) NOT NULL DEFAULT '#FFFFFF',
  text_color varchar(16) NOT NULL DEFAULT '#111827',
  border_color varchar(16) NOT NULL DEFAULT '#111827',
  button_background_color varchar(16) NOT NULL DEFAULT '#111827',
